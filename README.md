...
generator](#iam-policy-generator) has its own, separate coverage: 1486
...
| IAM policy generator (`iam`, 1486 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
