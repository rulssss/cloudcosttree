...
generator](#iam-policy-generator) has its own, separate coverage: 1527
...
| IAM policy generator (`iam`, 1527 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
