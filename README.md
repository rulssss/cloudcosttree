...
generator](#iam-policy-generator) has its own, separate coverage: 1611
...
| IAM policy generator (`iam`, 1611 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
