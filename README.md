...
generator](#iam-policy-generator) has its own, separate coverage: 1592
...
| IAM policy generator (`iam`, 1592 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
