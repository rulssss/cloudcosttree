...
generator](#iam-policy-generator) has its own, separate coverage: 1700
...
| IAM policy generator (`iam`, 1700 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
