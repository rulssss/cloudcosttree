...
generator](#iam-policy-generator) has its own, separate coverage: 1564
...
| IAM policy generator (`iam`, 1564 resource types) | Full policy, `Resource: "*"` | Full policy, `Resource: "*"` (per-resource ARN scoping planned) |
